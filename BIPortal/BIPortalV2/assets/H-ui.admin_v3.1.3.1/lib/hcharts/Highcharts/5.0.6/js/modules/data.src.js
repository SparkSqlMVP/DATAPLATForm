        ...
        Highcharts.extend(Data.prototype, {
                            ...
                            if (column[row + 1] !== undefined) {
                                ...
                                if (diff !== descending && descending !== undefined) {
                                    if (this.nativeFormat) {
                                        this.dateFormat = this.nativeFormat;
                                        row = column.length;
                                        this.nativeFormat = this.dateFormats[this.dateFormat].native;
                                    } else {
            ...
            dateFormats: {
                ...
                'dd/mm/YYYY': {
                    ...
                    native: 'mm/dd/YYYY' // different format with the same regex
                },
                'mm/dd/YYYY': {
                    regex: /^([0-9]{1,2})[\-\/\.]([0-9]{1,2})[\-\/\.]([0-9]{4})$/,
                    parser: function(match) {
                ...
                'dd/mm/YY': {
                    ...
                    native: 'mm/dd/YY' // different format with the same regex
                },
                'mm/dd/YY': {
                    regex: /^([0-9]{1,2})[\-\/\.]([0-9]{1,2})[\-\/\.]([0-9]{2})$/,
                    parser: function(match) {
                    ...
                    if (!dateFormat) {
                        for (key in this.dateFormats) {
                            ...
                            if (match) {
                                ...
                                this.nativeFormat = format.native;
