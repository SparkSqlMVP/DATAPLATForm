<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportServer.aspx.cs" Inherits="MagicLampERP.WebPage.BIServer.ReportServer" %>
    ...
    <asp:HiddenField ID="DatePickers" runat="server" />
        <div id="div1">
            ...
            <rsweb:ReportViewer WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="100%" Width="100%" SizeToReportContent="True" ID="ReportViewer1" runat="server" ProcessingMode="Remote">
                <ServerReport ReportServerUrl="https://bireport.tamiherefortamaki.nz/ReportServer" />
            </rsweb:ReportViewer>
        </div>
